...
• 📝 Data Modeling – Relationships established among tables (tracks, artists, streams, regions) to enable cross-filtering and aggregation.<br>
...
To deliver an interactive visual tool that enables music professionals to explore streaming performance globally, supports data-driven promotion decisions, and uncovers trends in genre popularity and artist performance by region.

**Walkthrough of Key Visuals**
- **Key KPIs:** Total streams, unique artists, total tracks, average streams per track, countries represented
- **Regional Filter Panel:** Interactive slicer to filter by country/region
- **Top Artists by Stream Count:** Bar chart ranking artists by total streams
- **Genre Distribution Worldwide:** Pie chart showing streaming share by genre
- **Track Performance Over Time:** Line chart displaying streaming trends
- **Artist Popularity by Region:** Heatmap highlighting regional performance
- **Listener Demographics:** Age group and geographic distribution analysis
- **Playlist Impact Analysis:** Scatter plot correlating playlists with stream growth
- **Emerging Artists Tracker:** Trend chart identifying rising artists

**Business Impact & Insights**
- Marketing Optimization: Identify high-potential artists for investment
- Regional Strategy: Tailor campaigns based on regional preferences
- Artist Development: Benchmark performance against peers
